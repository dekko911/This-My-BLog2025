			...
			<div className="justify-end items-center align-middle text-zinc-50 grid grid-rows-2 gap-y-4 pe-12">
				...
				<div className="flex justify-self-center self-start gap-x-3 scale-[150%]">
					<Link
						...
						className="hover:text-blue-600 duration-200 hover:-mt-1 hover:-rotate-[1.5deg]"
						target="_blank"
					>
						<FaFacebook />
					</Link>
					<Link
						...
						className="hover:text-pink-600 duration-200 hover:-mt-1 hover:-rotate-[1.5deg]"
						target="_blank"
					>
						<FaInstagram />
					</Link>
					<Link
						...
						className="hover:text-red-600 duration-200 hover:-mt-1 hover:-rotate-[1.5deg]"
						target="_blank"
					>
						<FaYoutube />
					</Link>
					<Link
						...
						className="hover:text-zinc-400 duration-200 hover:-mt-1 hover:-rotate-[1.5deg]"
						target="_blank"
					>
						<FaGithub />
					</Link>
